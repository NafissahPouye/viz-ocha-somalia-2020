...
var targetCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?dest=data_edit&strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F19bG17cqcgehiuwi96zFbaZGfggQVUGaD4a3iZ6F7VG8%2Fedit%23gid%3D935073182',
    dataType: 'json',
});

var progressCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?dest=data_edit&strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F19bG17cqcgehiuwi96zFbaZGfggQVUGaD4a3iZ6F7VG8%2Fedit%23gid%3D0',
    dataType: 'json',
});

var keyfigureTargetCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?dest=data_edit&strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F19bG17cqcgehiuwi96zFbaZGfggQVUGaD4a3iZ6F7VG8%2Fedit%23gid%3D1820516564',
    dataType: 'json',
});

var keyfigureProgressCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?dest=data_edit&strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F19bG17cqcgehiuwi96zFbaZGfggQVUGaD4a3iZ6F7VG8%2Fedit%23gid%3D959244210',
    dataType: 'json',
});

var descriptionCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?dest=data_edit&strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F19bG17cqcgehiuwi96zFbaZGfggQVUGaD4a3iZ6F7VG8%2Fedit%23gid%3D546323230',
    dataType: 'json',
});
